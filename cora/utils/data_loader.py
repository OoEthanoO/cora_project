...
def load_dem(tif_path: str) -> tuple[np.ndarray, Affine]:
...
if __name__ == '__main__':
    ...
    try:
        ...
        sample_file_path = os.path.join(project_root, 'data', 'n00_e006_1arc_v3.tif')
        ...
        if not os.path.exists(sample_file_path):
            ...
            dem_data, affine_transform = load_dem(sample_file_path)
